export const towns = [
  { name: 'Vicksburg', slug: 'vicksburg', businesses: 0 },
  { name: 'Bovina', slug: 'bovina', businesses: 0 },
  { name: 'Redwood', slug: 'redwood', businesses: 0 },
  { name: 'Yokena', slug: 'yokena', businesses: 0 },
  { name: 'Culkin', slug: 'culkin', businesses: 0 },
  { name: 'Newman', slug: 'newman', businesses: 0 },
];
